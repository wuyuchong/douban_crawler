...
\textsc{\Large 非结构化大数据分析}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 基于机器学习的《哈利波特》评论情感分类}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 15910852867}\\[0.5cm] % Minor heading such as course title
...
{\large 2022年6月28日}\\[2cm] % Date, change the \today to a set date if you want to be precise
